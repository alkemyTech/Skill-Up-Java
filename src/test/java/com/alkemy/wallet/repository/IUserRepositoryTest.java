...
//
//    @Mock protected IAccountRepository accountRepository;
//    @Mock protected IRoleRepository roleRepository;
//    @Mock protected ITransactionRepository transactionRepository;
//    @Mock protected IFixedTermDepositRepository fixedTermDepositRepository;
//
//    @Autowired protected IUserRepository underTest;
//
...
//        fixedTermDeposit1.setClosingDate(DateUtil.string2LocalDate("2023/01/26"));
...
//        fixedTermDeposit2.setClosingDate(DateUtil.string2LocalDate("2023/01/26"));
...
//        // Given
//        String emailThatDoesNotExist = "lucila@gmail.com";
//        underTest.save(user1);
//        underTest.save(user2);
//
//        // When
